...
import kotlinproject.composeapp.generated.resources.generic_do_not_show_again
                ...
                Card(
                    ...
                    Column(
                        ...
                        Column(
                            ...
                            Column(
                                modifier = Modifier.padding(top = grid_x4),
                                verticalArrangement = Arrangement.Bottom,
                                horizontalAlignment = Alignment.CenterHorizontally
                            ) {
                                if (announcement.allowNotShowAgain) {
                                    Row(
                                        verticalAlignment = Alignment.CenterVertically
                                    ) {
                                        FECallout3(text = stringResource(Res.string.generic_do_not_show_again), color = Color.Gray)
                                        Checkbox(checked, onCheckedChange = { checked = !checked })
                                    }
                                }
                                SGSmallPrimaryButton(
                                    modifier = Modifier.padding(top = grid_x1),
